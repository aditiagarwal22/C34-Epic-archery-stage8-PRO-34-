class PlayerArrow {
  ...
  shoot(archerAngle) {
    this.velocity = p5.Vector.fromAngle(archerAngle + PI / 2);//pi/2
  ...
  display() {
    ...
    }//Math.atan() here it means - Else tempangle will be calculated using the Math atan function it converts a number to radians
